    ...
    def matrixBlockSum(self, mat: List[List[int]], K: int) -> List[List[int]]:
        ...
        for y in range(0, h):
            ...
            for x in range(0, w):
                ...
                if y > 0: integral_image[y][x] += integral_image[y-1][x]
        ...
        for y in range(h):
            for x in range(w):
                ...
                if min_row > 0: output_image[y][x] -= integral_image[min_row-1][max_col]
                if min_col > 0: output_image[y][x] -= integral_image[max_row][min_col-1]
                if min_col > 0 and min_row > 0: output_image[y][x] += integral_image[min_row-1][min_col-1]
        return output_image