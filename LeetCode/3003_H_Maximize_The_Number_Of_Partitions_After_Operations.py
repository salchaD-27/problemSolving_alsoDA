...
class Solution:
    def maxPartitionsAfterOperations(self, s: str, k: int) -> int:
        ...
        for i in range(n):
            ...
            if min(combined_bits + 1, 26) <= k: total = left_groups + right_groups + 1
            elif left_bits == right_bits == k and combined_bits < 26: total = left_groups + right_groups + 3
            else: total = left_groups + right_groups + 2
